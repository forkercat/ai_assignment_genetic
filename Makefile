...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Thu May 18 20:29:56 2017
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ai_assignment_genetic1.0.0/ && $(COPY_FILE) --parents mydialog.h .tmp/ai_assignment_genetic1.0.0/ && $(COPY_FILE) --parents application.qrc .tmp/ai_assignment_genetic1.0.0/ && $(COPY_FILE) --parents mydialog.cpp main.cpp .tmp/ai_assignment_genetic1.0.0/ && (cd `dirname .tmp/ai_assignment_genetic1.0.0` && $(TAR) ai_assignment_genetic1.0.0.tar ai_assignment_genetic1.0.0 && $(COMPRESS) ai_assignment_genetic1.0.0.tar) && $(MOVE) `dirname .tmp/ai_assignment_genetic1.0.0`/ai_assignment_genetic1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ai_assignment_genetic1.0.0
